<x-layout title="Add Lead" title-icon="users" subtitle="Add a new lead and assign it to a salesperson">
    ...
    <form method="POST" action="{{ route('admin.leads.store') }}" class="mt-4">
        @csrf

        @include('admin.leads._form-fields', ['lead' => null])
