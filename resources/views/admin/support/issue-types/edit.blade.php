            ...
            <div class="p-6">
                ...
                <div class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="dashboard"
                                @selected(old('module', $issueType->module) === 'dashboard')>
                                Dashboard
                            </option>

                            <option
                                value="payment"
                                @selected(old('module', $issueType->module) === 'payment')>
                                Payment
                            </option>

                            <option
                                value="products"
                                @selected(old('module', $issueType->module) === 'products')>
                                Products
                            </option>

                            <option
                                value="system"
                                @selected(old('module', $issueType->module) === 'system')>
                                System
                            </option>

                            <option
                                value="website"
                                @selected(old('module', $issueType->module) === 'website')>
                                Website
                            </option>

                            <option
                                value="api"
                                @selected(old('module', $issueType->module) === 'api')>
                                API
                            </option>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option
                                value="low"
                                @selected(old('default_priority', $issueType->default_priority) === 'low')>
                                Low
                            </option>

                            <option
                                value="medium"
                                @selected(old('default_priority', $issueType->default_priority) === 'medium')>
                                Medium
                            </option>

                            <option
                                value="high"
                                @selected(old('default_priority', $issueType->default_priority) === 'high')>
                                High
                            </option>

                            <option
                                value="urgent"
                                @selected(old('default_priority', $issueType->default_priority) === 'urgent')>
                                Urgent
                            </option>
                ...
                <div class="mt-5">
                    ...
                    <textarea
                        ...
                        class="mt-1.5 w-full rounded-lg border-app-border text-sm shadow-sm focus:border-primary focus:ring-primary">{{ old('description', $issueType->description) }}</textarea>
                ...
                <div class="mt-6 rounded-lg border border-app-border bg-surface-alt p-4">
                    ...
                    <label class="flex cursor-pointer items-center justify-between gap-4">
                        ...
                        <input
                            ...
                            name="status"
                            value="1"
                            @checked(old('status', $issueType->status))
