<x-layout title="Ticket #{{ $ticket->ticket_number }}">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 ml-8 text-sm text-secondary">
                    ...
                    <div class="border-t border-app-border p-5">
                        ...
                        <form
                            ...
                            <textarea
                                ...
                                class="w-full rounded-lg border-app-border text-sm shadow-sm focus:border-primary focus:ring-primary"></textarea>
                ...
                @else
                    ...
                    <div class="border-t border-app-border bg-surface-alt p-4 text-center">
                        ...
                        <p class="text-sm text-secondary">
                            ...
                            This ticket is {{ $ticket->status }} and cannot receive new replies.
