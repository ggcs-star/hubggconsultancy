...
<head>
    ...
    <title>Session Expired · GG Hub</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn { display: inline-flex; align-items: center; gap: 8px; background: #6d28d9; color: #fff; text-decoration: none; font-weight: 600; font-size: 14px; padding: 12px 24px; border-radius: 12px; }
        .btn:hover { background: #5b21b6; }
    </style>
</head>
<body>
    <div class="card">
        <img src="/favicon.png" alt="GG Hub" class="logo">
        <h1>Session Expired</h1>
        <p>Your session has expired for your security. Please log in again to continue.</p>
